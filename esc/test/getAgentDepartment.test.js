...
const { getAgentDepartment } = require('../dbmanager.js');

describe('#getAgentDepartment()', function() {

    context('with correct inputs', function() {
        it('should return resolved promise for string input', function(done) {
            getAgentDepartment('abc')
                .then(() => {
