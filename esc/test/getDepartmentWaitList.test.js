...
const { getDepartmentWaitlist } = require('../dbmanager.js');

describe('#getDepartmentWaitlist()', function() {

    context('with correct inputs', function() {
        it('should return resolved promise for alphanumeric string input', function(done) {
            getDepartmentWaitlist('general')
                .then(() => {
