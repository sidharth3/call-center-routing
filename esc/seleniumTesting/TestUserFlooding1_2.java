...
public class TestUserFlooding1_2 {
...
public static void threadMaker2(int x) {
	for(int i=0;i<x;i++) {
...
public static void addUser2() throws InterruptedException {
...
//	driver2.get("http://localhost:3000/");
	...
	allClassSameType.get(1).click(); //0 1 2 depending on uPhone uPad or General
	Thread.sleep(20000);
