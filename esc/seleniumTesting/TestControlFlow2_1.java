...
public class TestControlFlow2_1 {
...
public static void startTestFlow2_1() throws InterruptedException{
	System.out.println("Testing control flow 2.1");
	...
	allClassSameType.get(0).click();  // 0 1 or 2
...
//	Thread.sleep(20000);
	...
	allClassSameType2.get(0).click();  // 0 1 or 2
	Thread.sleep(15000);
