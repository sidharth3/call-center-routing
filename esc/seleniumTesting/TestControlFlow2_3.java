...
public class TestControlFlow2_3 {
...
public static void startTestFlow2_3() throws InterruptedException{
	System.out.println("Testing control flow 2.3");
...
//	Thread.sleep(20000);
	...
	allClassSameType2.get(2).click();  // 0 1 or 2
	Thread.sleep(15000);
