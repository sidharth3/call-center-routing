...
class IMService {
    ...
    start(_options, _xmpp, _s2s, _rest, __conversations, __bubbles, _filestorage) {
        let that = this;
    ...
    sendMessageToConversation(conversation, message, lang, content, subject) {
        ...
        let msgSent = conversation.type === Conversation_1.Conversation.Type.ONE_TO_ONE ? this.sendMessageToJid(message, conversation.id, lang, content, subject) : this.sendMessageToBubbleJid(message, conversation.id, lang, content, subject, undefined);
