...
class Bubbles {
    ...
    start(_options, _xmpp, _s2s, _rest, _contacts, _profileService) {
        let that = this;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                that._rest.createBubble(name, description, withHistory).then((bubble) => {
                    ...
                    that._xmpp.sendInitialBubblePresence(bubble.jid).then(() => __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=BubblesService.js.map